...
func SxSumExcelTmp(year, mon int) (sx *SumExcelTmp) {
	...
	sx.SheetList[0].ContentFixed = map[string]string{
		...
		"地泵数据": "=" + "IFERROR(" + "'.." + sysSep + ".." + sysSep + "data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + "[" + sx.SheetList[0].ContentVariable["contentVar"] + ".xls]称重记录'!$L$5" + ",\"总车数：0  水渣：0  矿粉：0  其他：0\")",
		"录像数据": "='.." + sysSep + ".." + sysSep + "video_data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + "[" + sx.SheetList[0].ContentVariable["contentVar"] + ".xlsx]data'!$E$11",
		"比对结果": "",
		"地泵明细": "=HYPERLINK(\"" + ".." + sysSep + ".." + sysSep + "data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + sx.SheetList[0].ContentVariable["contentVar"] + ".xls\",\"" + sx.SheetList[0].ContentVariable["contentVar"] + "\")",
		"录像明细": "=HYPERLINK(\"" + ".." + sysSep + ".." + sysSep + "video_data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + sx.SheetList[0].ContentVariable["contentVar"] + ".xlsx\",\"" + sx.SheetList[0].ContentVariable["contentVar"] + "\")",
	}
	...
	sx.SheetList[2].ContentFixed = map[string]string{
		"日期":   "",
		"地泵数据": "='.." + sysSep + ".." + sysSep + "data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + "[" + sx.SheetList[0].ContentVariable["contentVar"] + ".xls]称重记录'!$L$6",
	}
...
func SxMakeSumExcelFile(year, mon int) (sxSumExcelFile *excelize.File, err error) {
	...
	for i := 1; i <= monDays; i++ {
		...
		// 地泵数据列
		sxTmp.SheetList[0].ContentFixed["地泵数据"] = "=" + "IFERROR(" + "'.." + sysSep + ".." + sysSep + "data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + "[" + sxTmp.SheetList[0].ContentVariable["contentVar"] + ".xls]称重记录'!$L$5" + ",\"总车数：0  水渣：0  矿粉：0  其他：0\")"
		...
		// 录像数据列
		sxTmp.SheetList[0].ContentFixed["录像数据"] = "='.." + sysSep + ".." + sysSep + "video_data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + "[" + sxTmp.SheetList[0].ContentVariable["contentVar"] + ".xlsx]data'!$E$11"
		...
		// 地泵明细列
		sxTmp.SheetList[0].ContentFixed["地泵明细"] = "=HYPERLINK(\"" + ".." + sysSep + ".." + sysSep + "data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + sxTmp.SheetList[0].ContentVariable["contentVar"] + ".xls\",\"" + sxTmp.SheetList[0].ContentVariable["contentVar"] + "\")"
		...
		// 录像明细列
		sxTmp.SheetList[0].ContentFixed["录像明细"] = "=HYPERLINK(\"" + ".." + sysSep + ".." + sysSep + "video_data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + sxTmp.SheetList[0].ContentVariable["contentVar"] + ".xlsx\",\"" + sxTmp.SheetList[0].ContentVariable["contentVar"] + "\")"
	...
	for i := 1; i <= monDays; i++ {
		...
		// 地泵数据列
		sxTmp.SheetList[2].ContentFixed["地泵数据"] = "='.." + sysSep + ".." + sysSep + "data" + sysSep + strconv.Itoa(year) + sysSep + fmt.Sprintf("%02d", mon) + sysSep + "[" + sxTmp.SheetList[2].ContentVariable["day"] + ".xls]称重记录'!$L$6"
